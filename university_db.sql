...
create table university.ref_positions (
...
create table university.teacher (
    ...
    constraint FK_TEACHER_2 foreign key (position_id) references ref_positions(position_id),
    constraint FK_TEACHER_3 foreign key (subject_id) references ref_subjects(subject_id)
);
...
insert into university.ref_positions value(1, "Assistant");
insert into university.ref_positions value(2, "Teacher");
insert into university.ref_positions value(3, "Dean");